...
describe('ProductBrowsing', () => {
  ...
  beforeEach(() => {
    vi.clearAllMocks();
    const { useGetListingsQuery, useGetCategoriesQuery } = require('../../../store/slices/apiSlice');
    useGetListingsQuery.mockImplementation(defaultMockQueries.useGetListingsQuery);
    useGetCategoriesQuery.mockImplementation(defaultMockQueries.useGetCategoriesQuery);
  });
  ...
  describe('Basic Rendering', () => {
    it('renders the main heading and description', () => {
      ...
      expect(screen.getByText('Fresh vegetables from local vendors')).toBeInTheDocument();
    });
  ...
  describe('Bulk Selection', () => {
    ...
    it('allows selecting products in bulk mode', async () => {
      ...
      const firstCard = productCards.find(card => 
        within(card).queryByText('Out of Stock') === null
      );
  ...
  describe('Comparison Functionality', () => {
    ...
    it('navigates to comparison page when compare button is clicked', async () => {
      ...
      expect(mockNavigate).toHaveBeenCalledWith('/restaurant/comparison');
    });
  });
  ...
  describe('Add to Cart', () => {
    ...
    it('disables add button for out of stock products', () => {
      ...
      const productCard = outOfStockText.closest('[data-testid*="product-card"]');
  ...
  describe('Navigation', () => {
    ...
    it('navigates to cart when view cart button is clicked', async () => {
      ...
      expect(mockNavigate).toHaveBeenCalledWith('/restaurant/cart');
    });
  });
