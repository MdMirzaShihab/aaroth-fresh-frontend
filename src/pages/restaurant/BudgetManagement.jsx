...
import { useGetRestaurantBudgetQuery } from '../../store/slices/apiSlice';
import { formatCurrency } from '../../utils';
import Button from '../../components/ui/Button';
import BudgetCreationModal from '../../components/restaurant/BudgetCreationModal';
import BudgetEditModal from '../../components/restaurant/BudgetEditModal';
...
const BudgetManagement = () => {
  ...
  // Fetch budget data
  const { data: budgetData, isLoading, refetch } = useGetRestaurantBudgetQuery(
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-text-muted dark:text-dark-text-muted font-light">
              Track and manage your restaurant spending limits
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="glass-layer-1 dark:glass-1-dark rounded-3xl p-12 text-center mb-8">
            ...
            <p className="text-text-muted dark:text-dark-text-muted mb-6">
              Create a budget to track and manage your restaurant spending
            </p>
            {user?.role === 'restaurantOwner' && (
              <Button
                onClick={() => setIsCreateModalOpen(true)}
