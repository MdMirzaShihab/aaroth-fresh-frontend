  ...
  const quickActions = [
    {
      ...
      action: () => handleQuickNavigation('/admin/verifications'),
      priority: 1,
    },
    {
    ...
    },
    {
      ...
      route: '/admin/users?bulk=true',
      action: () => handleQuickNavigation('/admin/users?bulk=true'),
      priority: 4,
    },
    {
      id: 'flagged-listings',
      ...
      route: '/admin/content/flagged',
      action: () => handleQuickNavigation('/admin/content/flagged'),
      priority: 5,
    },
    {
      id: 'system-reports',
    ...
    },
    {
      ...
      action: () => handleQuickNavigation('/admin/system/performance'),
      priority: 8,
    },
  ];
