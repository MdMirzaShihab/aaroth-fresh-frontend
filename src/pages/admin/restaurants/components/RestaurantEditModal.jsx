...
import { useUpdateRestaurantMutation } from '../../../../store/slices/apiSlice';
import { addNotification } from '../../../../store/slices/notificationSlice';
import Button from '../../../../components/ui/Button';

const RestaurantEditModal = ({ restaurant, isOpen, onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: restaurant.phone || restaurant.userId?.phone || '',
    email: restaurant.email || restaurant.userId?.email || '',
    ...
    operatingPermit: restaurant.operatingPermit || '',
  });
    ...
    try {
      ...
      Object.keys(restaurantData || {}).forEach(key => {
        if (key === 'address' || key === 'businessHours') {
          submitData.append(key, JSON.stringify(restaurantData[key]));
        } else if (Array.isArray(restaurantData[key])) {
          submitData.append(key, JSON.stringify(restaurantData[key]));
        } else {
          submitData.append(key, restaurantData[key]);
        }
      });
      ...
      dispatch(
        addNotification({
          type: 'error',
          title: 'Update Failed',
          message: error.data?.message || 'Failed to update restaurant information',
        })
      );
    }
  };
      ...
      <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] flex flex-col animate-scale-in">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-text-dark">Edit Restaurant</h2>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Enter restaurant business name"
                  />
                  {errors.businessName && (
                    <p className="text-tomato-red text-sm mt-2 flex items-center gap-2">
                      <AlertTriangle className="w-4 h-4" />
