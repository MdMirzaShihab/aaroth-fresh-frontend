/**
 * CreateBuyerOwner - Buyer Owner Creation Wizard
...
import { useCreateBuyerOwnerMutation } from '../../../services/admin/usersService';
...
const CreateBuyerOwner = ({ isOpen, onClose, onSuccess }) => {
  const { isDarkMode } = useTheme();
  const [currentStep, setCurrentStep] = useState(0);
  const [createOwner, { isLoading }] = useCreateBuyerOwnerMutation();
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: Building,
      description: 'Buyer information and business details',
    },
    {
      id: 'documents',
      title: 'Documents',
    ...
    },
    {
      ...
      title: 'Review',
      icon: Settings,
      description: 'Review and submit buyer owner application',
    },
  ];
  ...
  const onSubmit = useCallback(
    async (data) => {
      try {
        ...
        toast.error('Failed to create buyer owner');
      }
    },
    ...
    <Modal isOpen={isOpen} onClose={handleClose} size="2xl">
      <div className="p-6">
        ...
        <div className="text-center mb-6">
          ...
          >
            Complete the form to add a new buyer owner to the platform
          </p>
        </div>
...
export default CreateBuyerOwner;
