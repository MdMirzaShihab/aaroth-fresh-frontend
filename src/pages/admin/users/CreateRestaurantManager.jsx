...
import { useCreateRestaurantManagerMutation } from '../../../services/admin/usersService';
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    >
                      {selectedOwner.businessName} •{' '}
                      {selectedOwner.restaurantCount} restaurant
                      {selectedOwner.restaurantCount !== 1 ? 's' : ''}
                    </div>
                  </div>
                </div>
              </div>
          ...
          <Card className="p-6">
            ...
            >
              ...
              restaurant owner or system administrators.
            </div>
          </Card>
