...
const ManagerManagement = () => {
  ...
  const openEditModal = (manager) => {
    ...
    setManagerForm({
      ...
      email: manager.email || '',
      phone: manager.phone || '',
      role: manager.role || 'buyerManager',
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-xs text-text-muted">
                  {manager.role === 'buyerManager' ? 'Manager' : 'Owner'}
                </span>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 bg-white border border-gray-200 rounded-2xl focus:outline-none focus:ring-2 focus:ring-muted-olive/20 focus:border-muted-olive"
                >
                  <option value="buyerManager">Manager</option>
                </select>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                {Object.entries({
                  ...
                  manageProfile: 'Manage Buyer Profile',
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-text-muted">
                        {key === 'viewOrders' &&
                          'Allow viewing all buyer orders'}
                        {key === 'placeOrders' && 'Allow placing new orders'}
                        {key === 'manageProfile' &&
                          'Allow editing buyer profile'}
                        {key === 'manageManagers' &&
                          'Allow creating/editing other managers'}
                        {key === 'viewAnalytics' &&
                          'Allow viewing buyer analytics'}
                      </p>
                    </div>
                  </label>
                ))}
            ...
            <div className="glass rounded-3xl p-12">
              ...
              <p className="text-text-muted mb-8">
                {searchQuery || statusFilter
                  ...
                  : 'Add your first manager to help run your buyer'}
              </p>
              <button
                onClick={() => {
                  resetForm();
