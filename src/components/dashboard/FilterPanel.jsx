        ...
        <div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
          ...
          {activeFilterCount > 0 && (
            <button
              ...
              className="p-2 hover:bg-gray-100 rounded-xl transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-bottle-green/20 touch-target"
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 rounded-2xl border border-gray-200 focus:border-bottle-green focus:ring-2 focus:ring-bottle-green/20 transition-all text-sm touch-target"
              />
            </div>
          </div>
        )}
              ...
              <button
                ...
                className={`px-2.5 sm:px-3 py-2 rounded-xl text-xs sm:text-sm font-medium transition-all duration-200 touch-target ${
                  filters.dateRange?.type === option.value
                    ...
                    : 'bg-gray-100 text-text-dark hover:bg-gray-200 active:bg-gray-300'
                }`}
              >
        ...
        {showCategory && categories.length > 0 && (
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 rounded-2xl border border-gray-200 focus:border-bottle-green focus:ring-2 focus:ring-bottle-green/20 transition-all"
            >
          ...
          <div className="flex flex-wrap gap-2">
            {Object.entries(filters).map(([key, value]) => {
              ...
              return (
                <span
                  key={key}
                  className="inline-flex items-center gap-1 bg-bottle-green/10 text-bottle-green px-3 py-1 rounded-full text-sm font-medium"
                >
                  {key}: {displayValue}
                  <button
                    onClick={() =>
