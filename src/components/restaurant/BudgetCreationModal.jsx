...
import { useCreateRestaurantBudgetMutation } from '../../store/slices/apiSlice';

const BudgetCreationModal = ({ isOpen, onClose, onSuccess }) => {
  const [createBudget, { isLoading }] = useCreateRestaurantBudgetMutation();
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-text-muted dark:text-dark-text-muted">
                Set spending limits for your restaurant
              </p>
            </div>
          </div>
          <button
