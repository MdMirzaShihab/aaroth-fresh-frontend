...
const TableRow = forwardRef(
  ({ className, clickable = false, onClick, children, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
...
const TableCell = forwardRef(
  ({ className, align = 'left', children, ...props }, ref) => {
    ...
    return (
      <td
        ref={ref}
        className={cn('px-4 py-3 text-text-dark', alignClass, className)}
        {...props}
      >
        {children}
      </td>
...
export const DataTable = ({
  ...
  return (
    <div
      className={cn(
        'bg-white rounded-3xl shadow-sm border border-gray-200 overflow-hidden',
        className
      )}
      {...props}
    >
          ...
          <TableRow>
            {columns.map((column) => (
              <TableHead
                ...
                onSort={
                  onSort
                    ? (direction) => onSort(column.key, direction)
                    : undefined
                }
                align={column.align}
              >
