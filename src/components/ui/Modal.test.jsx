...
describe('Modal Component', () => {
  ...
  it('renders close button when showCloseButton is true', () => {
    render(
      <Modal open={true} onOpenChange={vi.fn()} showCloseButton={true}>
        <div>Modal Content</div>
      </Modal>
    );
  ...
  it('does not render close button when showCloseButton is false', () => {
    render(
      <Modal open={true} onOpenChange={vi.fn()} showCloseButton={false}>
        <div>Modal Content</div>
      </Modal>
    );
  ...
  it('calls onOpenChange when close button is clicked', async () => {
    ...
    render(
      <Modal open={true} onOpenChange={handleOpenChange} showCloseButton={true}>
        <div>Modal Content</div>
      </Modal>
    );
  ...
  it('renders as drawer on mobile when variant is drawer', () => {
    render(
      <Modal open={true} onOpenChange={vi.fn()} variant="drawer">
  ...
  describe('Accessibility', () => {
    it('announces modal opening to screen readers', () => {
      render(
        <Modal open={true} onOpenChange={vi.fn()} title="Important Modal">
          <div>Modal Content</div>
        </Modal>
      );
