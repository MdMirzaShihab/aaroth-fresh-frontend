...
export const useCreateListing = () => {
  const [createListingMutation, { isLoading, error }] = useCreateListingMutation();
...
export const useUpdateListing = () => {
  const [updateListingMutation, { isLoading, error }] = useUpdateListingMutation();
  const [imageFiles, setImageFiles] = useState([]);
...
export const useDeleteListing = () => {
  const [deleteListingMutation, { isLoading, error }] = useDeleteListingMutation();
...
export const useListingActions = () => {
  ...
  return {
    ...
    isLoading: createActions.isLoading || updateActions.isLoading || deleteActions.isLoading,
  };
};