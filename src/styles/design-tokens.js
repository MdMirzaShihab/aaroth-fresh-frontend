...
export const components = {
  ...
  input: {
    ...
    select:
      'w-full px-6 py-4 rounded-2xl bg-earthy-beige/30 border-0 focus:bg-white focus:shadow-lg appearance-none cursor-pointer transition-all duration-300 min-h-[44px]',
  },

  // Card Patterns
  card: {
    product:
      'bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm hover:shadow-2xl hover:shadow-shadow-soft transition-all duration-500 p-6 border border-white/50 hover:-translate-y-1 group',
    dashboard:
      'bg-gradient-glass backdrop-blur-md rounded-3xl p-8 border border-white/20 shadow-soft',
    modal:
      'bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 max-w-md mx-auto border border-white/50 animate-scale-in',
  },
