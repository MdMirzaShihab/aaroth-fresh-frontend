  ...
  try {
    ...
    return {
      ...
      data: {
        ...
        mediumUrl: result.secure_url.replace('/upload/', '/upload/w_800,h_800,c_fit/'),
        width: result.width,
...
export const getResponsiveImageUrls = (publicId) => {
  ...
  return {
    ...
    small: getOptimizedImageUrl(publicId, { width: 300, height: 300, crop: 'fit' }),
    medium: getOptimizedImageUrl(publicId, { width: 600, height: 600, crop: 'fit' }),
    large: getOptimizedImageUrl(publicId, { width: 1200, height: 1200, crop: 'fit' }),
...
export const validateImageFile = (file, constraints = {}) => {
  ...
  if (!allowedFormats.includes(fileExtension)) {
    errors.push(`Invalid format. Allowed formats: ${allowedFormats.join(', ')}`);
  }
 ...
 */
export const getPlaceholderImageUrl = (width = 400, height = 400, text = 'Loading...') => {
 ...
 */
export const batchUploadImages = async (files, options = {}, onProgress = null) => {
